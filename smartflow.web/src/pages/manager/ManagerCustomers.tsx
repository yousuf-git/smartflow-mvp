...
import { getManagerCustomers, type AdminCustomer } from "../../lib/managerApi";
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-ink-300">Customers who used this plant</p>
      </div>
                ...
                {customers.length === 0 && (
                  <tr>
                    <td colSpan={5} className="px-5 py-10 text-center text-ink-300">
                      No customers have used this plant yet.
                    </td>
                  </tr>
                )}
              </tbody>
